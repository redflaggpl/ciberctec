        ...
        <tr>
          <td>
	         <form name="adminForm" id="adminForm" method="post" 
	               action="index2.php?com=catedras&do=new">
		          <table width="100%" cellspacing="0" cellpadding="0">
		            ...
		            <tr>
			            <td  class="headlines">Nombre</td>
			              <td><input type="text" name="nombre" id="nombre" class="required">
			            <td>
			            ...
			            <td  class="headlines">Programa</td>
			              <td>
			                  <select name="programas_id" 
			                          id="programas_id" class="required" >
			                          <option value="">--</option>
			            ...
			            <td class="headlines">Semestre: </td>
			             <td>
			                <select name="semestre" id="semestre" class="required" ">
								<option value="">--</option>
					  			{html_options options=$semestres }
							  </select> 
						 </td>
			              <td  class="headlines">Horas</td>
			              <td><input type="text" id="horas" name="horas" class="required" size="2"></td>
		            </tr>
		            <tr>
